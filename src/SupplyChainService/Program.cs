...
{
    c.SwaggerDoc("v1", new() { Title = "GlobalMart OS — Supply Chain & Import Service (MS-6)", Version = "v1" });
...
{
    app.UseSwagger();
    app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MS-6 Supply Chain v1"));
}
